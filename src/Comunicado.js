...
export default function () {
  return (
    <div className="container">
      ...
      <p>
        <b>Emergencia Con Transparencia</b>, un ejercicio ciudadano lanzado por
        las organizaciones Colectivo Nosotros, Evolución Mexicana, Redes Quinto
        Poder IDEA y Vertebra Nuevo León, reconoce a los diez entes públicos que
        voluntariamente se sumaron a este ejercicio, les reconoce también el
        esfuerzo por recopilar, sistematizar, publicar y difundir la información
        del gasto relativo a las medidas para atender la emergencia por el
        COVID-19, por avanzar en la mejora de sus sitios de transparencia y por
        ser abiertos a las sugerencias hechas por el equipo de las ONGs.
      </p>
      <p>
        A todos los entes se les dio a conocer en tiempo y forma que, cumplidas
      ...
      <p>
        ...
        evaluaciones semanales se sostuvieron al menos dos reuniones de trabajo
        con cada uno de los 10 entes públicos que voluntariamente aceptaron
        participar en este ejercicio ciudadano.
      </p>
      <p>
        Las evaluaciones obtenidas en los rankings de Emergencia Con
        Transparencia no significan aprobación y/o validación de la información
        publicada en los sitios de los entes públicos.
      </p>
      <p>
        Hacemos un llamado a la ciudadanía, ONGs y medios de comunicación a
        meternos todas y todos, al fondo a comparar información, precios, bienes
        ya que con ello coadyuvamos al buen ejercicio de los recursos. Sabemos
        que la corrupción mata, pero hoy más que nunca el buen ejercicio del
        dinero de los contribuyentes puede hacer la diferencia entre la vida y
        la muerte.
      </p>
      <p>
        Exhortamos a los entes públicos a seguir actualizando la información en
        sus micrositios ya que con la primera evaluación mensual el próximo
        nueve de agosto, arranca la segunda etapa de Emergencia con
        Transparencia.
      </p>
      <div className="text-center">
        <button className="button">Descarga el Comunicado</button>
      </div>
    </div>
  );
}
